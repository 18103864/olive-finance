                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex relative">
                            <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
                                <circle cx="21" cy="21" r="20" fill="#F3EDF7" stroke="#DDD1E8"/>
                            </svg>
                        ...
                        <div className="flex items-center gap-1">
                            <span className="text-lg font-medium text-[#9B7EBD]">
                                {address ? truncateAddress(address) : 'Connected'}
                            </span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M12.5 2.5H17.5V7.5" stroke="#9B7EBD" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M8.33594 11.6667L17.5026 2.5" stroke="#9B7EBD" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M15 10.8333V15.8333C15 16.2754 14.8244 16.6993 14.5118 17.0118C14.1993 17.3244 13.7754 17.5 13.3333 17.5H4.16667C3.72464 17.5 3.30072 17.3244 2.98816 17.0118C2.67559 16.6993 2.5 16.2754 2.5 15.8333V6.66667C2.5 6.22464 2.67559 5.80072 2.98816 5.48816C3.30072 5.17559 3.72464 5 4.16667 5H9.16667" stroke="#9B7EBD" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
                    </div>
